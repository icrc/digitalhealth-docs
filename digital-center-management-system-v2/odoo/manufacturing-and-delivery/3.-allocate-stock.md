...
Inside the SU[^2] form, you will find a tab called "Stock Pickings", where all stock movements created for this [SU ](#user-content-fn-2)[^2]are listed. In this case, we will open the one with the "Waiting Another Operation" status.
...
When clicking "Moves", you will be taken to the following page listing the Detailed Operations:
...
If no "Done quantities" are recorded, a pop-up will ask you if you want to create a backorder if you expect to process the remaining products later, or to proceed without creating a backorder if you will not process the remaining products.&#x20;

<figure><img src="../../.gitbook/assets/image (374).png" alt=""><figcaption></figcaption></figure>

3\.     Updating the quantity line by line.

Sometimes the quantity is hidden. To show it, click on the three dots and select "Quantity". This will display the quantity to be retrieved and the correct value to populate in the respective column.
