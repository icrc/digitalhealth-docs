...
To start the repair process in Odoo, click on "Start Repair". If an error pop-up appears, refer to \[[this guide](https://app.gitbook.com/s/nTWGcVv7ikvz7HIC0Dby/troubleshooting-and-faq)].
