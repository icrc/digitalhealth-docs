...
Then, you tick the relevant box "Invite a colleague" and you can "Add Another Expert" if you wish.

An email or SMS will be sent to your contact in the interpreting organization.

The third party can join a video call already in progress even if they missed the start of the session.

> ⚠ Warning
>
> It is strongly recommended, whenever possible, to plan the session in advance to ensure that an interpreter is available.&#x20;
